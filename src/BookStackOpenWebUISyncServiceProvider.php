        ...
        return [
            ...
            'openwebui' => [
                ...
                'paths' => [
                    ...
                    'file_search' => '/api/v1/files/search',
                    'knowledge_file_add' => '/api/v1/knowledge/{id}/file/add',
                    'knowledge_file_update' => '/api/v1/knowledge/{id}/file/update',
                    'knowledge_file_remove' => '/api/v1/knowledge/{id}/file/remove',
                    'knowledge_files' => '/api/v1/knowledge/{id}/files',
                    'file_delete' => '/api/v1/files/{id}',
                    'file_content_update' => '/api/v1/files/{id}/data/content/update',
